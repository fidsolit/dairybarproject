...
<head>
  ...
  <link href="https://db.onlinewebfonts.com/c/4476a7ce4b2e68f7b26fd3967c5a4827?family=Douceur+Black+W00+Regular"
    rel="stylesheet">
  ...
  <style>
    .logoTitle {
      /* color: "whitesmoke"; */
      color: "#000";
      font-family: "Douceur Black W00 Regular";
    ...
    .slogan {
      color: "red";
      font-family: "Selfie Neue Round Regular";
      font-style: "italic";
    }
  </style>
      ...
      <div class="nav-bar">
        <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <!-- <h1 class="text-center logoletterK" style="font-family:Copperplate; color:whitesmoke;"> KAKKA</h1><span -->
            <h1 class="text-center logoTitle"> KAKKA
            </h1><span class="sr-only"></span>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
...
//$result = mysqli_query($link, $query);
  ...
  <section id="hero" style="position: relative;">
    ...
    <img src="../image/img/background.svg"
      style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
    <div class="hero container" style="position: relative; z-index: 1;">
      <div>
        <h1><strong>
            <h1 class="text-center logoTitle"> KAKKA </h1><span></span>
          </strong></h1>
        <h1 class="slogan">Dairy Bar<span></span></h1>
        ...
        <div class="mainDish">
          ...
          <?php foreach ($mainDishes as $item): ?>
            <p>
              ...
              <span class="item-price">Php &nbsp; <?php echo $item['item_price']; ?></span><br>
  ...
  <div class=" about container">
    <div class="col-right">
      ...
      <h2>KAKKA DAIRY BAR History:</h2>
      <p>KAKKA DAIRY BAR is a well-established Western food establishment in the city's heart. KAKKA DAIRY BAR's
        has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing
        meal, with a focus on providing delicious meals and a friendly dining experience.
      </p>
      <p>KAKKA DAIRY BAR, as a Western restaurant, offers a diverse menu that caters to a variety of tastes. The
        menu includes a wide range of options such as bar bites, salads, soups and a variety of main courses. Customers
        can savour succulent options such as steak and ribs, chicken, lamb, seafood, burgers and sandwiches, pasta, and
        a variety of delectable side dishes. The menu has been carefully curated to offer a balance of classic
        favourites and innovative creations, ensuring that every palate is satisfied.
      </p>
      <p>KAKKA DAIRY BAR's ability to accommodate customers is one of its distinguishing features. Johnny's Dining
        & Bar strives to create an inviting and comfortable dining environment, whether guests prefer to walk in or make
        reservations in advance. The restaurant recognises the significance of creating memorable experiences,
        particularly for those celebrating special occasions. Johnny's Dining & Bar is a popular choice for families,
        couples, and groups of friends because of its attentive staff and welcoming atmosphere.
      </p>
      <p>KAKKA DAIRY BAR has an inviting outdoor bar that is open seven days a week from 11:00 AM to 10:00 PM in
        addition to the indoor dining area.This outdoor space provides a relaxed setting for patrons to unwind and
        socialise while sipping on their favourite drinks and nibbling on bar bites. The bar serves a wide range of
        beverages, including cocktails, wines, beers and non-alcoholic options.
      </p>
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>N Escario St, Cebu City, 6000 Cebu</h2>
        </div>
      </div>
    </div>
    </div>
  ...
  <section id="footer">
    <div class="footer container">
      <div class="brand">
        <h1>Your Dairy bar</h1>
      </div>
      <h2>Follow our Socials</h2>
      <div class="social-icon">
        <div class="social-item">
          <a href="https://www.facebook.com"><img src="https://img.icons8.com/color/48/facebook.png"
              alt="facebook" /></a>
        </div>
        <div class="social-item">
          <a href="https://www.instagram.com"><img src="https://img.icons8.com/color/48/instagram-new.png"
              alt="instagram-new" /></a>
        </div>
        <div class="social-item">
          <a href="https://www.pinterest.com"><img src="https://img.icons8.com/color/48/pinterest.png"
              alt="pinterest-new" /></a>
        </div>
        <div class="social-item">
        ...
        <div class="social-item">
          <a href="https://www.youtube.com"><img src="https://img.icons8.com/color/48/youtube-play.png"
              alt="youtube-new" /></a>
        </div>


      </div>
      <p>© 2024 KAKKA DAIRY BAR </p>
