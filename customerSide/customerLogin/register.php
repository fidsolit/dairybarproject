...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["email"]))) {
        ...
        $email_err = "Please enter a valid email. Ex: fidem0411@gmail@email.com";
    } else {
...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('../image/loginBackgroundnew.jpg');
    ...
    <div class="register-container">
        <div class="register_wrapper"> <!-- Updated class name -->
            <a class="nav-link" href="../home/home.php#hero">
                <h1 class="text-center" style="font-family:Copperplate; color:white;"> KAKKA LOGIN</h1><span
                    class="sr-only"></span>
            </a><br>
            ...
            <p style="margin-top:1em; color:white;">Already have an account? <a
